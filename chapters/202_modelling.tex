...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{assets/model-Endo Dim 1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{assets/model-Endo Dim 2.png}
...
Simulating a 170\,cm flexible tube via FEM would cripple frame rates. Instead, we \textbf{decouple forward translation from tip articulation}. The tip attaches to an \textbf{invisible kinematic pusher} gliding along a centerline spline at \textbf{2\,cm/s}. Freed from soft-body physics, the agent focuses purely on \textbf{local visual steering}, preserving \textbf{hundreds of frames per second} for Deep RL!
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{assets/model-Snare Dimensions.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{assets/model-Snare Clamp Levels.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{assets/model-Colon Dim.png}
\caption{The colon 3D model in wireframe and shaded views, showing anatomical dimensions and haustral curves.}
...
We built a custom \textbf{physically based rendering (PBR)} shader with a fleshy albedo map and high-smoothness specular map. We paired this with a rapidly decaying \textbf{point light} attached to the camera, mimicking a real endoscope. Figure~\ref{fig:model_colon_insides} illustrates the resulting interior view.

\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{assets/model-Colon Insides.png}
\caption{Interior view showing haustral mesh topology and our custom PBR shader with dynamic point-light illumination.}
\label{fig:model_colon_insides}
\end{figure}

\paragraph{Why lighting matters.}
This environment is highly challenging: intense \textbf{specular highlights}, \textbf{dynamic shadows}, and \textbf{light attenuation} create harsh gradients. Processing this visual noise forces the CNN to learn \textbf{robust, invariant features}.
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{assets/model-Polyp Dimensions.png}
\caption{Our pedunculated polyp model (PBR material and wireframe), measuring 30\,mm by 80\,mm.}
