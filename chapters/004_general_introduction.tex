...
why \textbf{polypectomy} matters \cite{winawer1993polypectomy}. Even though the
...
combining computer vision and \textbf{deep reinforcement learning} (Deep RL, learning by trial and
...
\item to study how machine learning, deep learning, and \textbf{deep reinforcement learning}
...
\item \textbf{Learning pipeline:} use Convolutional Neural Networks (CNNs) for visual encoding
and deep reinforcement learning with Proximal Policy Optimization (PPO) for sequential control, with careful reward shaping.
...
\item \textbf{Chapter 1 - State of the Art:} a concise review that situates the
	...
	deep reinforcement learning that are relevant to the project. This chapter highlights
...
\item \textbf{Chapter 2 - Contributions:} an account of the implemented system and
	the original contributions. In short, this chapter presents an attempt on a
		extbf{two-phase endoscope deep reinforcement learning system} that combines a
	...
	trained with deep reinforcement learning. The chapter documents the design choices,
